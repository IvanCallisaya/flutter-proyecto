    ...
    return Scaffold(
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          ...
          color: Color.fromARGB(255, 11, 5, 177),
        )),
        title: const Text(
          'Traductor',
          style: TextStyle(
      ...
      body: SingleChildScrollView(
        ...
        children: [
          ...
          ElevatedButton(
              ...
              style: ButtonStyle(
                  backgroundColor:
                      MaterialStatePropertyAll(Color.fromARGB(255, 26, 42, 225)),
                  fixedSize: const MaterialStatePropertyAll(Size(300, 45))),
              child:isloading?const SizedBox.square(
                dimension: 20,
                child: CircularProgressIndicator(color: Color.fromARGB(255, 255, 248, 248),),
              ): const Text('Traducir')),
          const SizedBox(
            height: 30,
          )
